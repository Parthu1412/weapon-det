// PersonDetection struct and nlohmann/json deserialization helpers.
// Represents a single person bounding-box payload exchanged over ZMQ
// between camera_reader (port 5560) and the person_detection binary.
#pragma once
 ...
 */
inline void parse_person_detections_json(const nlohmann::json& j, std::vector<PersonDetection>& out)
{
    out.clear();
