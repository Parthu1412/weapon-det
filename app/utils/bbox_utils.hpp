// Bounding-box utility interface — IoU calculation, box expansion, best-person
// extraction from person-detection results.
#pragma once
...
/** IoU, box expansion, person box extraction */
class BBoxUtils
{
public:
